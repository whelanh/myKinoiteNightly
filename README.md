...
## 💽 My Custom Image
![Custom](https://img.shields.io/badge/Custom-0066cc?style=flat)*[@1/16/2026 -- I've temporarily changed the base image I use in my recipe-nvidia.yml to Kinoite-Beta:rawhide because Kinoite-Nightly Rawhide hasn't been updated for awhile. To check status see: [https://quay.io/repository/fedora-ostree-desktops/kinoite-nightly?tab=tags](https://gitlab.com/fedora/ostree/ci-test/-/pipelines)*
